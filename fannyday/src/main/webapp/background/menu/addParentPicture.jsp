...
<body>
<form action="saveParentPicture.action" method="post" class="definewidth m20">
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td><input type="text" name="parent_picture_name"/></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><input type="text" name="skim_count"/></td>
    </tr>
    
     <tr>
        <td class="tableleft">url</td>
        <td><input type="text" name="picture_url"/></td>
    </tr>
    <tr>
